...
public class carGenerator : MonoBehaviour
{
    ...
    void spawnCar()
    {
        ...
        if (!checkSpawnCollision(spawnPointsAndPaths[spawn].spawnPoint.transform.position, 4f)){
            ...
            //create new car
            Quaternion direction = Quaternion.Euler(0f, -90f * spawn, 0f);
            GameObject newCar = Instantiate(carPrefab, spawnPointsAndPaths[spawn].spawnPoint.transform.position, direction);
